(function () {
    ...
    const valores = [
        ["AC", "rojo"], ["C", "naranja"], ["←", "naranja"], ["÷", "azul"], ["(", "morado"], [")", "morado"], ["x", "morado"], ["y", "morado"], ["7", "numero"], ["8", "numero"], ["9", "numero"], ["*", "azul"], ["4", "numero"], ["5", "numero"], ["6", "numero"], ["-", "azul"],
        ["1", "numero"], ["2", "numero"], ["3", "numero"], ["+", "azul"], ["0", "numero"], [".", "numero"], ["=", "verde"], ["Evaluar", "verde"]
    ];

    valores.forEach(([texto, clase]) => {
    ...
    calc.appendChild(botones);
  
    const hist = document.createElement("div");
    hist.className = "historial";
